  ...
  return (
    <div className="main-page theme-page theme-ani" style={{ background: pageBg, color: '#3A2410' }}>
      ...
      <section className="hero theme-hero" style={{ background: `linear-gradient(180deg, ${heroBg1} 0%, ${heroBg2} 100%)`, borderBottom: `1px solid rgba(255,142,43,0.15)` }}>
        ...
        <div className="hero-bg" aria-hidden={true} style={{ backgroundImage: `linear-gradient(rgba(255,255,255,0.6), rgba(255,255,255,0.6)), url('/src/assets/Image/Copilot_20260519_135952.png')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundBlendMode: 'overlay', height: 'auto', width: '100%' }} />
