...
const TOP_PICKS = [
  ...
  { rank: '02', name: '을지로 골뱅이',  category: '안주·포차 · 중구',  rating: 4.8, dist: '350m',  tag: '인기',   tagBg: '#FFF0F0', tagColor: '#E8272A' },
  { rank: '03', name: '광장시장 빈대떡',category: '전통·분식 · 종로구',rating: 4.6, dist: '720m',  tag: '맛집',   tagBg: '#FFF7E0', tagColor: '#B7791F' },
]
    ...
    <div className="main-page">
      ...
      <section className="hero">
        ...
        <div className="hero-text">
          ...
          <div className="hero-cta">
            ...
            <button className="btn-ghost"   onClick={() => navigate('/map')}>실시간 리뷰 보기</button>
          </div>
        </div>
        <div className="hero-stats">
          <div className="stat">
            <div className="stat-num">1<span>,240</span></div>
            <div className="stat-label">등록 맛집</div>
          </div>
          <div className="stat">
            <div className="stat-num">43<span>명</span></div>
            <div className="stat-label">지금 보는 중</div>
          </div>
        </div>
      </section>
      ...
      <div className="map-banner">
        <div>
          ...
          <p className="map-banner-sub">카카오맵 연동으로 실시간 위치 기반 길찾기까지 한 번에</p>
        </div>
        <button className="btn-white" onClick={() => navigate('/map')}>지도 바로 가기</button>
      </div>
    </div>
  )
}
