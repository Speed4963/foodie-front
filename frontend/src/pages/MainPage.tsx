...
const MainPage: React.FC<Props> = ({ onNavigate }) => (
  <div className="main-page">
    ...
    <section className="section">
      <div className="section-head">
        ...
        <span className="section-more" onClick={() => onNavigate('map')}>전체 보기 →</span>
      </div>
      <div className="cat-grid">
        {CATEGORIES.map((cat, i) => (
          <div key={i} className="cat-card" onClick={() => onNavigate('map')}>
    ...
    <section className="section" style={{ paddingTop: 0 }}>
      <div className="section-head">
        ...
        <span className="section-more" onClick={() => onNavigate('map')}>지도에서 보기 →</span>
      </div>
      <div className="picks-row">
        {TOP_PICKS.map((p, i) => (
          <div key={i} className={`pick-card ${p.featured ? 'featured' : ''}`} onClick={() => onNavigate('map')}>
