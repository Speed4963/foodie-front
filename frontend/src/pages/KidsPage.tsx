  ...
  return (
    <div className="main-page theme-page theme-kids" style={{ background: '#FFF8F1', color: '#4A3428' }}>
      ...
      <section className="hero theme-hero" style={{ background: 'linear-gradient(135deg, #FFE7CC 0%, #FFF5E9 45%, #FFFDF8 100%)' }}>
        ...
        <div className="hero-bg" aria-hidden={true} style={{ backgroundImage: `linear-gradient(rgba(255,255,255,0.6), rgba(255,255,255,0.1)), url('/src/assets/Image/Copilot_20260519_122937.png')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundBlendMode: 'overlay', height: 'auto', width: '100%' }} />
